...
import iKi.com.MainActivity
import iKi.com.NotificationHelper
import iKi.com.R
...
class FService : Service() {
    ...
    private fun startFService() {
        ...
        val description = "we have example"
